...
public class Slayer extends JavaPlugin implements Listener {
    ...
    private Integer vgFeroDivision = 2;
    ...
    private static Map<String, List<Player>> emanFighterMap = new HashMap<>();
    ...
    public void onEntityDamage(final EntityDamageByEntityEvent event){
        ...
        if (entity instanceof Enderman && damager instanceof Player){
            ...
            if (normalEmans.contains(entityID) && !onBeam.contains(entityID)){
                ...
                if (isAtomsplit){
                    damage *= random.nextDouble(0.0055d, 0.065d);   // 2M
                } else {
                ...
                health = toBossHealth(remaining_health - damage);
                eman.setHealth(remaining_health - damage);
                event.setDamage(0d);
